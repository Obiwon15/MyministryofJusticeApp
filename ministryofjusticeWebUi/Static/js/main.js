...
jQuery(document).ready(function($) {
    ...
    var siteMenuClone = function() {
        ...
        setTimeout(function() {
                ...
                $('.site-mobile-menu .has-children').each(function() {
                    ...
                    $this.find('.arrow-collapse')
                        .attr({ 'data-toggle': 'collapse', 'data-target': '#collapseItem' + counter, });
    ...
    var siteCountDown = function() {
        $('#date-countdown').countdown('2020/10/10',
            function(event) {
    ...
    siteDatePicker();
    var siteSticky = function() { $(".js-sticky-header").sticky({ topSpacing: 0 }); };
    siteSticky();
    ...
    var accordion = function() {
        ...
        $('.collapse').on('show.bs.collapse', function() { $(this).closest('.accordion-item').addClass('active'); });
        $('.collapse').on('hidden.bs.collapse',
            function() { $(this).closest('.accordion-item').removeClass('active'); });
    }
    accordion();
});