...
namespace ministryofjusticeWebUi.Controllers
{
	public class AccountController : Controller
	{
		...
		private readonly ILoginCheckServices _loginCheck;

		public AccountController()
		{
		}
		public AccountController(ILoginCheckServices loginCheck)
		{
			...
			switch (result)
			{
				case SignInStatus.Success:
					if (returnUrl == null)
					{
						...
						//Checks if Session ID already exist
						if (userList.Contains(Session.SessionID))
						{
							AuthenticationManager.SignOut(DefaultAuthenticationTypes.ApplicationCookie);
							ModelState.AddModelError("", "User already logged-in elsewhere ");
							return View(model);
						}

						userList.Add(Session.SessionID);
